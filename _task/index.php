...
">
           <button type="button" class="btn btn-primary" style="margin-left: 0px;" >
            <i class="fa fa-check"></i> Sign off
          </button>

          <button type="button" class="btn btn-success" style="margin-left: 0px;" >
            <i class="fa fa-street-view"></i> Ongoing
          </button>
          <button type="button" class="btn alert-danger " style="margin-left: 0px;" >
            <i class="fa fa-warning"></i> Problem
          </button>
          <button type="button" class="btn alert-warning " style="margin-left: 0px;" >
...
<script>
  ...
  dp.startDate = new DayPilot.Date ("2020-01-12");
