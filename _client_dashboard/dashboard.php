...
$get_task = "select * from project ORDER BY id DESC"; 
...
?>
 ...
 <?php if($row['status'] == 'active'){ ?>
  ...
  <span class="info-box-number"><a href="task_list.php?editid=<?php echo $row['id'];?>">Project Name: <?php echo $row['project_name'];?></a></span>
