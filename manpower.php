   ...
   <nav class="navbar navbar-static-top">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="#">Manpower <span class="sr-only">(current)</span></a></li>
          </ul>
...
<div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Add Project Manpower </a></li>
              <li><a href="#timeline" data-toggle="tab">Manpower List</a></li>
 ...
 ?>
   ...
   <?php }?>
                  ...
                  <div class="form-group">
                  	<label for="project_name" class="col-sm-3 control-label">Designation:</label>

                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="" name="designation" required>
                  	</div>
                </div>

                <div class="form-group">
                  	<label for="project_name" class="col-sm-3 control-label">No of Workers:</label>

                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="" name="no_work" required>
                  	</div>
                </div>
                <div class="form-group">
                  	<label for="project_name" class="col-sm-3 control-label">Rate per day:</label>

                  	<div class="col-sm-9">
                    	<input type="text" class="form-control" id="" name="rate_day" required>
                  	</div>
                </div>
...
if(ISSET($_POST['add'])){
    ...
    mysqli_query($con, "INSERT INTO project_manpower(designation, no_of_workers, rate_per_day, total_cost, project_id) VALUES ('$designation', '$no_work', '$rate', '$total', '$project_id')");
