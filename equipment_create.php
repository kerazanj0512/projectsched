   ...
   <nav class="navbar navbar-static-top">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="active"><a href="#">Equipment <span class="sr-only">(current)</span></a></li>
          </ul>
...
<div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#activity" data-toggle="tab">Add Project Equipment </a></li>
              <li><a href="#timeline" data-toggle="tab">Equipement List</a></li>
 ...
 ?>
   ...
   <?php }?>
                  ...
                  <div class="form-group">
                  	<label for="project_name" class="col-sm-3 control-label">Unit:</label>
                ...
                <div class="form-group">
                  	<label for="project_name" class="col-sm-3 control-label">Utilize Hr.:</label>
                ...
                <div class="form-group">
                  	<label for="project_name" class="col-sm-3 control-label">Rent Per Hour:</label>
...
if(ISSET($_POST['add'])){
    ...
    $unit = $_POST['unit'];
    $utilize = $_POST['utilize'];
    $rent = $_POST['rent'];
    $total= $rent * $utilize;

    
    mysqli_query($con, "INSERT INTO project_equipment (unit, utilize_hours, rent, total_cost, project_id) VALUES ('$unit', '$utilize', '$rent', '$total', '$project_id')");
