          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="_client_dashboard/">Client Login</a></li>
                  <li class="divider"></li>
...
<script>
  $(function () {
    ...
    var donutData = [
      { label: 'Complete', data: 30, color: '#3c8dbc' },
      { label: 'In-complete', data: 20, color: '#0073b7' },
      { label: 'Not Started', data: 50, color: '#00c0ef' }
    ]
